<template>
  <section>
    <div class="pt-28 pb-20 px-10 mx-auto my-auto">
      <div
        class="container w-3/5 shadow-md bg-gray-100 mx-auto my-auto px-10 pt-10 pb-10 text-left rounded-lg"
      >
        ...
        <div class="block uppercase font-bold text-black pb-1">Message:</div>
        <div
          class="container bg-white mx-auto my-auto px-10 py-24 pt-10 pb-52 text-left rounded-lg"
        >
        ...
        <div class="pt-5">
          <button
            class="inline-flex items-center block uppercase text-black font-bold bg-white border-0 py-1 px-3 focus:outline-none hover:bg-gray-100 rounded text-base mt-4 md:mt-0"
            @click="toInboxPage"
          >
            Back
          </button>
