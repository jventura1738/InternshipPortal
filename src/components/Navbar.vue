        ...
        <div>
          <span class="relative cursor-pointer">
            ...
            <div v-if="numMessages > 0">
              <span
                class="absolute top-0 -right-7 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full"
                >{{ numMessages }}</span
              >
            </div>
          </span>
